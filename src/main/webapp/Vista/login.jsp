<%-- 
    Document   : login
    Created on : 26 ago 2024, 20:30:16
    Author     : Joaquin
--%>
...
<html lang="en">
    ...
    <style>
        body {
            ...
            margin: 0;
            height: 100vh;
            background: url('${pageContext.request.contextPath}/img/banner_log.jpg') no-repeat center center fixed;
        ...
        .body-overlay {
            ...
            z-index: 0; /* Colocado detrás del contenedor */
        }
        ...
        .contenedor-login {
            ...
            position: fixed; /* Ahora es fijo para centrarse siempre */
            top: 50%;
            left: 50%;
            transform: translate(-50%, -50%);
            z-index: 1; /* Asegura que el contenedor de login esté encima del overlay */
            overflow: hidden;
        }

        .cuadro-info, .cuadro-login {
            width: 50%;
        }
    ...
    <body>
        ...
        <div class="contenedor-login">
            <div class="cuadro-info">
                ...
                <button class="btn-registro" id="btn-registro">Regístrate</button>
            </div>
        ...
        <script>
            ...
            document.getElementById('btn-registro').addEventListener('click', function () {
                window.location.href = contextPath + '/Vista/register.jsp';
            });
        </script>

        <script>
            document.addEventListener('DOMContentLoaded', function () {
                // Mostrar la alerta si el login falló
            <% if (request.getAttribute("loginFallido") != null && (boolean) request.getAttribute("loginFallido")) { %>
                Swal.fire({
                    icon: 'error',
                    title: 'Error de inicio de sesión',
                    text: 'Correo o contraseña incorrectos. Por favor, inténtalo de nuevo.',
                    confirmButtonText: 'Aceptar',
                    backdrop: false // Desactiva el fondo de la alerta
                });
