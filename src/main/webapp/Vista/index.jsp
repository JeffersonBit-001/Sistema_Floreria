<%-- 
    Document   : index
    Created on : 26 ago 2024, 20:29:28
    Author     : Joaquin
--%>
    ...
    <body>
        ...
        <section class="banner">
            <div class="content-banner">
                <p>Flores Hermosas</p>
                <h2>100% Natural <br />Arreglos de Flores</h2>
        ...
        <main class="main-content">
            <section class="container container-features">
                ...
                <div class="card-feature">
                    ...
                    <div class="feature-content">
                        <span>Distintos medios de Pago</span>
                        <p></p>
                    </div>
                </div>
                <div class="card-feature">
                    ...
                    <div class="feature-content">
                        <span>Perfecto para todo tipo de regalos</span>
                        <p></p>
                    </div>
                </div>
                <div class="card-feature">
            ...
            <section class="container top-categories">
                ...
                <div class="container-categories">
                    <div class="card-category category-moca">
                        <p>Box Rosas</p>
                        <a href="Box Rosas.jsp">
                            <span>Ver más</span>
                        </a>
                    </div>
                    <div class="card-category category-expreso">
                        <p>Box Girasoles</p>
                        <a href="Box Girasoles.jsp">
                            <span>Ver más</span>
                        </a>
                    </div>
                    <div class="card-category category-capuchino">
                        <p>Box Tulipanes</p>
                        <a href="Box Tulipanes.jsp">
                            <span>Ver más</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="container-products">
                    ...
                    <div class="card-product">
                        <div class="container-img">
                            <a href="DetallesDeProduc/detalle_Produc_Tuli.jsp"><img src="../img/Box 1.jpg" alt="Cafe Irish" /></a>
                        ...
                        <div class="content-card-product">
                            ...
                            <p class="price">S/50 <span>S/75</span></p>
                        </div>
                    </div>
                    </a>
                    <!-- Producto 2 -->
                    <div class="card-product">
                        <div class="container-img">
                            <a href="DetallesDeProduc/detalle_Produc_Rosa.jsp"> <img
                                    src="../img/Box 3.jpg"
                        ...
                        <div class="content-card-product">
                            ...
                            <h3>Box Rosas Gigante</h3>
                            <span class="add-cart">
                                <i class="fa-solid fa-basket-shopping"></i>
                            </span>
                            <p class="price">S/200 <span>S/230</span></p>
                        </div>
                    </div>
                    <!--  -->
                    <div class="card-product">
                        <div class="container-img">
                            <a href="DetallesDeProduc/detalle_Produc_Amor.jsp"><img
                                    src="../img/Box 8.jpeg"
                    ...
                    <div class="card-product">
                        <div class="container-img">
                            <a href="DetallesDeProduc/detalle_Produc_Gira.jsp"><img src="../img/Box 14.png" alt="Cafe Helado" ></a>
                            <div class="button-group">
                                <span>
                                    <i class="fa-regular fa-eye"></i>
                                </span>
            ...
            <section class="gallery">
                <img
                    src="../img/flores 1.jpg"
                    alt="Gallery Img1"
                    class="gallery-img-1"
                    /><img
                    src="../img/flores 6.jpg"
                    alt="Gallery Img2"
                    class="gallery-img-2"
                    /><img
                    src="../img/flores 4.jpg"
                    alt="Gallery Img3"
                    class="gallery-img-3"
                    /><img
                    src="../img/flores 7.jpg"
                    alt="Gallery Img4"
                    class="gallery-img-4"
                    /><img
                    src="../img/flores 5.jpg"
                    alt="Gallery Img5"
                    class="gallery-img-5"
                    />
            </section>
            ...
            <section class="container specials">
                ...
                <div class="container-products">
                    ...
                    <div class="card-product">
                        <div class="container-img">
                            <img src="../img/Box 1.jpg" alt="Cafe Irish" />
                            <span class="discount">-13%</span>
                            <div class="button-group">
                                <span>
                                    <i class="fa-regular fa-eye"></i>
                    ...
                    <div class="card-product">
                        <div class="container-img">
                            <img src="../img/Box 8.jpeg" alt="Cafe Viena" />
                    ...
                    <div class="card-product">
                        <div class="container-img">
                            <img src="../img/Box 14.png" alt="Cafe Liqueurs" />
                            <div class="button-group">
                                <span>
                                    <i class="fa-regular fa-eye"></i>
                                </span>
