<%-- 
    Document   : detalle_Produc_Amor
    Created on : 22 sept 2024, 12:50:20
    Author     : Joaquin
--%>
            ...
            <div class="product-page">
                ...
                <div class="product-images">
                    <div class="main-image">
                        <center><img src="../../img/Box 8.jpeg" alt="Producto Principal"></center>
                    </div>
                    <div class="other-variations">
                        <img src="../../img/Box 8.jpeg" alt="Variación 1">
                        <img src="../../img/Box Amor 2.jpg" alt="Variación 2">
                        <img src="../../img/Box Amor 3.jpg" alt="Variación 3">
                    </div>
                </div>

                <!-- Product Details -->
                <div class="product-info">
                    <h1 class="product-title">Caja de Amor</h1>
                    <p class="product-code">Código del Producto: AMOR456DEF78</p>
                    ...
                    <p class="product-description">
                        Esta hermosa caja especial de San Valentín incluye: <br>
                        - 12 Rosas rojas premium <br>
                        - 12 Rosas rosadas de alta calidad <br>
                        - Follaje delicado con detalles dorados <br>
                        - Topper con frase romántica como "Te Amo" o "Feliz Día" <br>
                        - Tarjeta personalizada para tu mensaje especial <br>
                        Perfecto para una ocasión especial con ese ser amado.
                    </p>

                    <!-- Form to Add to Cart -->
                    <form action="${pageContext.request.contextPath}/ControlCarrito" method="post">
                        <div class="product-options">
                            ...
                            <input type="hidden" name="id_flor" value="4">
                            <input type="hidden" name="precio" value="120"> <!-- Aquí va el precio -->
                    ...
                    <div class="delivery-info">
                        ...
                        <p>Entregamos en todo el país con opciones de envío exprés por San Valentín. Haz tu pedido antes de las 10:00 a.m. para entrega el mismo día.</p>

                        <h2>Políticas de Devoluciones</h2>
                        <p>Ofrecemos devoluciones dentro de las 48 horas posteriores a la entrega. El producto debe estar en condiciones originales. Contáctanos para más detalles.</p>
                    </div>
        ...
        <form action="${pageContext.request.contextPath}/ControlComent" method="POST" class="review-form">
            ...
            <div class="form-group">
                ...
                <div class="star-rating">
                    <input type="hidden" name="flor_id" value="4">
