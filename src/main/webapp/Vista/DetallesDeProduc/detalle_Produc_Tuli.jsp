<%-- 
    Document   : detalle_Produc_Tuli
    Created on : 22 sept 2024, 12:50:35
    Author     : Joaquin
--%>
            ...
            <div class="product-page">
                ...
                <div class="product-images">
                    <div class="main-image">
                        <center><img src="../../img/Box 1.jpg" alt="Producto Principal"></center>
                    </div>
                    <div class="other-variations">
                        <img src="../../img/Box 1.jpg" alt="Variación 1">
                        <img src="../../img/BoxTuli 2.jpg" alt="Variación 2">
                        <img src="../../img/Box Tuli 3.jpg" alt="Variación 3">
                    </div>
                </div>

                <!-- Product Details -->
                <div class="product-info">
                    <h1 class="product-title">Caja de Tulipanes</h1>
                    <p class="product-code">Código del Producto: TUL987HJK23</p>
                    <div class="product-price">
                        <span class="current-price">S/50</span>
                    </div>
                    ...
                    <p class="product-description">
                        Caja elegante con 10 Tulipanes de colores <br>
                        Follaje natural <br>
                        Topper "Feliz Día" o "Te Quiero" <br>
                        Tarjeta personalizada <br>
                        Box rectangular de diseño exclusivo <br>
                        Colores disponibles: Rosa, Blanco, Amarillo
                    </p>
                    ...
                    <form action="${pageContext.request.contextPath}/ControlCarrito" method="post">
                        <div class="product-options">
                            ...
                            <input type="hidden" name="id_flor" value="2">
                            <input type="hidden" name="precio" value="50"> <!-- Aquí va el precio -->
                    ...
                    <div class="delivery-info">
                        ...
                        <p>Realizamos entregas en toda la ciudad con opciones de envío el mismo día. Pedidos realizados antes de las 12:00 p.m. tienen entrega garantizada el mismo día.</p>

                        <h2>Políticas de Devoluciones</h2>
                        <p>Aceptamos devoluciones en un plazo de 24 horas desde la entrega. El producto debe estar en su estado original. Contáctanos para más detalles.</p>
                    </div>
        ...
        <form action="${pageContext.request.contextPath}/ControlComent" method="POST" class="review-form">
            ...
            <div class="form-group">
                ...
                <div class="star-rating">
                    <input type="hidden" name="flor_id" value="2">
